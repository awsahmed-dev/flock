...
const nextConfig: NextConfig = {
  ...
  //
  // It was here because @react-three/fiber's type deps collapsed prop
  // inference in a few polymorphic components, and eleven "not
  // assignable to never" errors were judged cosmetic. They were — but
  // the flag is not: with it on, a genuinely broken refactor compiles
  // and deploys. That nearly happened, so the eleven were fixed at
  // source instead and the flag is gone.
  images: {
    remotePatterns: [
