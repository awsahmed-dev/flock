...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${trip.name} · Sawia`,
    description: `Check out this ${trip.destination} trip planned with Sawia`,
    openGraph: {
      title: `${trip.name} · Sawia`,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-white">
      ...
      <div className="border-t border-white/10 bg-white/3">
        <div className="max-w-3xl mx-auto px-6 py-12 text-center space-y-5">
          ...
          <div>
            <h2 className="text-xl font-bold">Plan your group trip with Sawia</h2>
