...
/**
 * NOW-cockpit demo — a faithful miniature of the planning cockpit:
 * countdown chip, readiness bar (moss, fills on view), day chips, and
 * the activity ticker. Non-interactive by design; the point is "your
 * home screen knows what week it is", not a widget toy.
 */
  ...
  return (
    <DemoFrame toneClass="from-[#8B7CFF]/[0.07] to-transparent">
      ...
      <div className="flex-1 px-4 py-4 flex flex-col gap-3 overflow-hidden">
        ...
        {/* Readiness */}
        <div className="rounded-2xl bg-[#1A1A1A] border border-white/[0.06] p-3.5">
          <div className="flex items-center justify-between mb-2">
            <p className="text-[12px] font-semibold text-white">Trip readiness</p>
            <p className="text-[12px] font-bold text-[#9BC97E] tabular-nums">57%</p>
          </div>
        ...
        {/* Ticker */}
        <div className="rounded-2xl bg-[#1A1A1A] border border-white/[0.06] px-3.5 py-3">
        ...
        {/* Offline chip — the Pocket Day promise lives here */}
        <div className="mt-auto flex items-center gap-2 rounded-2xl border border-[#E0B252]/25 bg-[#E0B252]/[0.07] px-3.5 py-3">
