  ...
  return (
    <div className="rounded-[28px] border border-white/[0.08] bg-gradient-to-br from-white/[0.04] to-transparent backdrop-blur-md p-5 shadow-[0_30px_80px_-20px_rgba(99,102,241,0.35)]">
      ...
      <div className="space-y-1.5 mb-4">
        ...
        />
        <DashRow
          icon={<MapPin className="w-3.5 h-3.5 text-fuchsia-400" />}
          title="Shibuya Sky"
      ...
      <div className="grid grid-cols-3 gap-2 pt-3 border-t border-white/[0.06]">
        ...
        <DashStat label="You owe" value="$84" tint="text-orange-300" />
  ...
  return (
    <div
      className={`flex items-center gap-2.5 rounded-lg px-2 py-2 ${
        highlight
          ? "bg-gradient-to-r from-emerald-500/10 to-transparent ring-1 ring-emerald-500/20"
          : "hover:bg-white/[0.03]"
      } transition-colors`}
    >
  ...
  return (
    <div className="w-[210px] rounded-2xl border border-white/[0.08] bg-black/80 backdrop-blur-md p-3.5">
      <div className="flex items-center gap-1.5 mb-2.5">
        ...
        <p className="text-[10px] tracking-wider uppercase font-bold text-blue-300">
          Plan · Day 2
        </p>
      </div>
  ...
  return (
    <div className="w-[230px] rounded-2xl border border-white/[0.08] bg-black/80 backdrop-blur-md p-3.5">
      <div className="flex items-center gap-1.5 mb-2">
        ...
        <p className="text-[10px] tracking-wider uppercase font-bold text-violet-300">
          Open vote
        </p>
      </div>
      ...
      <div className="space-y-1.5">
        <div className="relative h-6 rounded-md bg-white/[0.04] overflow-hidden">
          <div className="absolute inset-y-0 left-0 w-[68%] bg-gradient-to-r from-violet-500/40 to-violet-500/20" />
  ...
  return (
    <div className="w-[220px] rounded-2xl border border-white/[0.08] bg-black/80 backdrop-blur-md p-3.5">
      <div className="flex items-center gap-1.5 mb-2">
        ...
        <p className="text-[10px] tracking-wider uppercase font-bold text-emerald-300">
          Expense · split 4
        </p>
      </div>
      ...
      <div className="mt-2.5 pt-2.5 border-t border-white/[0.06] flex items-center justify-between">
        ...
        <p className="text-xs font-bold tabular-nums text-orange-300">$120</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="w-[230px] rounded-2xl border border-white/[0.08] bg-black/80 backdrop-blur-md p-3.5">
      <div className="flex items-center gap-1.5 mb-2.5">
        ...
        <p className="text-[10px] tracking-wider uppercase font-bold text-fuchsia-300">
          Chat · AI active
        </p>
      </div>
      <div className="space-y-1.5">
