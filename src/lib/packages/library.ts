...
const BATUMI_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Dzveli Tsiskvili", nameAr: "الطاحونة القديمة", why: "A working watermill turned restaurant on the road back into town — grilled trout and mchadi cornbread baked from the mill's own flour, eaten on a balcony over the stream. The menu carries pork as well.", whyAr: "طاحونة ماء شغّالة صارت مطعم على طريق الرجعة للمدينة — تراوت مشوي وخبز ذرة «مشادي» من طحين الطاحونة نفسها، بشرفة فوق الجدول. وبالقائمة لحم خنزير كذلك.", category: "food", rating: 4.4, priceBand: 2, startTime: "17:30", dietary: ["pork-served"] },
    ],
  },
];
