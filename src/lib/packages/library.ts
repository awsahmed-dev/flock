...
const SAPPORO_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      ...
      { name: "Ganso Ramen Yokochō", nameAr: "زقاق غانسو رامن", why: "Eight seats a shop, and the miso ramen comes with a film of fat on top that keeps it scalding to the last spoon.", whyAr: "ثمانية كراسي بكل محل، ورامن الميسو فوقه طبقة دهن تخليه حار لآخر ملعقة.", category: "food", rating: 4.1, priceBand: 1, startTime: "19:00" },
    ],
  },
  {
    key: "sapporo-otaru",
