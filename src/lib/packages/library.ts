...
const TOKYO_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      ...
      { name: "Nonbei Yokocho", nameAr: "نونبي يوكوتشو", why: "Tiny lantern-lit alley behind the noise — six seats per bar, no menus in English, all the better.", whyAr: "زقاق ضيق بفوانيس خلف الزحمة — ستة كراسي بكل محل، وبدون قائمة إنجليزية، وهذا أحلى.", category: "food", rating: 4.5, priceBand: 2, startTime: "19:30", adultsOnly: true },
    ],
  },
  {
    key: "tokyo-old",
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Omoide Yokocho", nameAr: "أومويدي يوكوتشو", why: "Smoke, skewers, and elbow room for nobody. Dinner standing up.", whyAr: "دخان وأسياخ وزحمة — عشاء وأنتم واقفين.", category: "food", rating: 4.4, priceBand: 2, startTime: "19:00", adultsOnly: true },
    ],
  },
  {
    key: "tokyo-bay",
    ...
    titleAr: "جهة الخليج",
    places: [
      { name: "Toyosu Market", nameAr: "سوق تويوسو", why: "Get to the third-floor sushi counters before 7 — same fish that came off the auction, half the queue.", whyAr: "اطلعوا لمطاعم السوشي بالدور الثالث قبل السابعة — نفس السمك النازل من المزاد، وبنص الطابور.", category: "food", rating: 4.4, priceBand: 2, startTime: "07:00" },
...
const KYOTO_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Ninenzaka and Sannenzaka", nameAr: "نينينزاكا وسانينزاكا", why: "Two stone lanes stepping down from the temple — this is the Kyoto on every postcard, and it's genuinely that.", whyAr: "زقاقين حجريين ينزلون درج من المعبد — هذي كيوتو اللي بكل البطاقات، وهي فعلًا كذا.", category: "walk", rating: 4.5, priceBand: 1, startTime: "09:30" },
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Pontochō alley", nameAr: "زقاق بونتوتشو", why: "One lane wide with the river down one side — pick a place with a menu you can actually read and eat on the terrace.", whyAr: "زقاق بعرض واحد والنهر من جهة — اختاروا مكان قائمته تقدرون تقرونها وكلوا على الشرفة.", category: "food", rating: 4.5, priceBand: 2, startTime: "18:30", adultsOnly: true },
    ],
  },
  {
    key: "kyoto-uji",
...
const OSAKA_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Shinsekai and Tsūtenkaku", nameAr: "شينسيكاي وبرج تسوتنكاكو", why: "A 1950s idea of the future, gone gently to seed — eat kushikatsu, and never dip a skewer twice.", whyAr: "تصوّر الخمسينات عن المستقبل وقد بهت على مهل — كلوا كوشيكاتسو، وممنوع تغمسون السيخ مرتين.", category: "walk", rating: 4.2, priceBand: 1, startTime: "12:00" },
      { name: "Abeno Harukas 300", nameAr: "أبينو هاروكاس ٣٠٠", why: "The tallest building in Japan — go up an hour before sunset and stay until the grid lights up.", whyAr: "أطول مبنى باليابان — اطلعوا قبل الغروب بساعة واقعدوا لين تضوي شبكة المدينة.", category: "sight", rating: 4.5, priceBand: 2, startTime: "16:30" },
    ],
  },
  {
    key: "osaka-water",
...
const HAKONE_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      ...
      { name: "Lake Ashi crossing", nameAr: "عبور بحيرة أشي", why: "Cross by boat rather than bus and watch the far shore — on a clear afternoon Fuji is sitting right behind it.", whyAr: "اقطعوا بالقارب بدل الباص وراقبوا الضفة البعيدة — بعصر صافي بيكون فوجي واقف خلفها مباشرة.", category: "sight", rating: 4.4, priceBand: 2, startTime: "12:30" },
      { name: "Hakone Shrine", nameAr: "ضريح هاكوني", why: "The red gate standing in the lake has a real queue for the photo; the cedar stairway up behind it has nobody at all.", whyAr: "البوابة الحمراء الواقفة بالبحيرة عندها طابور حقيقي للصورة؛ أما درج الأرز اللي خلفها فما فيه أحد.", category: "sight", rating: 4.6, priceBand: 0, startTime: "14:30" },
...
const KANAZAWA_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      { name: "Ōmichō Market", nameAr: "سوق أوميتشو", why: "Seafood bowls for breakfast — the counters at the back of the market cost half what the ones by the entrance do.", whyAr: "أطباق بحرية للفطور — المطاعم بآخر السوق بنص سعر اللي عند المدخل.", category: "food", rating: 4.3, priceBand: 2, startTime: "09:00" },
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Wada House", nameAr: "بيت وادا", why: "Climb up into the roof space and look at the joints — the whole frame is tied with rope, not a nail in it.", whyAr: "اطلعوا لفراغ السقف وشوفوا الوصلات — الهيكل كله مربوط بالحبال، ما فيه ولا مسمار.", category: "sight", rating: 4.3, priceBand: 1, startTime: "12:00" },
...
const HIROSHIMA_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      ...
      { name: "Okonomimura", nameAr: "أوكونومي-مورا", why: "Four floors of okonomiyaki griddles in one building — Hiroshima's version has noodles layered inside it.", whyAr: "أربعة طوابق صواني أوكونوميّاكي بمبنى واحد — ونسخة هيروشيما فيها نودلز بداخلها.", category: "food", rating: 4.2, priceBand: 1, startTime: "13:30" },
    ],
  },
  {
...
const SAPPORO_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      ...
      { name: "Nijō Market", nameAr: "سوق نيجو", why: "Crab and sea urchin bowls eaten at the counter — ask the price before you sit down, not after.", whyAr: "أطباق سلطعون وقنفذ بحر تتاكل عند الطاولة — اسألوا عن السعر قبل ما تقعدون، مو بعدها.", category: "food", rating: 4.1, priceBand: 2, startTime: "12:00" },
      ...
      { name: "Ganso Ramen Yokochō", nameAr: "زقاق غانسو رامن", why: "Eight seats a shop, and the miso ramen comes with a film of fat on top that keeps it scalding to the last spoon.", whyAr: "ثمانية كراسي بكل محل، ورامن الميسو فوقه طبقة دهن تخليه حار لآخر ملعقة.", category: "food", rating: 4.1, priceBand: 1, startTime: "19:00", adultsOnly: true },
    ],
  },
  {
    key: "sapporo-otaru",
    ...
    places: [
      ...
      { name: "Otaru Sushiya-dōri", nameAr: "شارع السوشي بأوتارو", why: "A whole street of sushi counters fed by that morning's boats, and the set menus cost less than in Sapporo.", whyAr: "شارع كامل مطاعم سوشي من صيد نفس الصباح، وقوائمه أرخص من سابورو.", category: "food", rating: 4.5, priceBand: 2, startTime: "14:00" },
    ],
  },
  {
    ...
    places: [
      { name: "Hoheikyo Onsen", nameAr: "أونسن هوهيكيو", why: "An hour out of the city into a gorge — outdoor baths, and an Indian curry kitchen inside that makes no sense and is excellent.", whyAr: "ساعة برا المدينة داخل وادي — أحواض مكشوفة، وجوّا مطبخ كاري هندي ما له تفسير وهو ممتاز.", category: "rest", rating: 4.5, priceBand: 2, startTime: "11:00" },
...
const KAMAKURA_DAYTRIP: CuratedDay = {
  ...
  places: [
    ...
    { name: "Komachi-dōri", nameAr: "شارع كوماتشي", why: "Lunch as a walk between the station and the big shrine — the whitebait, raw or grilled, is the local order.", whyAr: "غداء وأنتم ماشين بين المحطة والضريح الكبير — والشيراسو، نيء أو مشوي، هو طلب أهل المنطقة.", category: "food", rating: 4.2, priceBand: 1, startTime: "13:30" },
...
const ISTANBUL_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Balat streets", nameAr: "شوارع بلاط", why: "Painted houses stacked up a steep hill — the antique shops on Vodina are what makes the detour worth it.", whyAr: "بيوت ملونة مركومة على تلة حادة — ومحلات الأنتيك بشارع فودينا هي اللي تخلي اللفة تستاهل.", category: "walk", rating: 4.4, priceBand: 0, startTime: "11:30" },
      { name: "Eyüp Sultan Mosque", nameAr: "جامع أبي أيوب الأنصاري", why: "The mosque this city loves most, and the calmest courtyard in it — go outside the Friday hour.", whyAr: "المسجد الأحب على قلب هالمدينة، وأهدأ صحن فيها — روحوا بغير وقت الجمعة.", category: "sight", rating: 4.8, priceBand: 0, startTime: "15:00" },
      { name: "Pierre Loti Hill", nameAr: "تلة بيير لوتي", why: "The cable car climbs over the cemetery to a terrace with tea and the entire Golden Horn under it at sunset.", whyAr: "التلفريك يطلع فوق المقبرة لشرفة فيها شاي والقرن الذهبي كله تحتها وقت الغروب.", category: "sight", rating: 4.5, priceBand: 1, startTime: "17:00" },
    ],
  },
];
...
const PRINCES_ISLANDS_DAYTRIP: CuratedDay = {
  ...
  places: [
    ...
    { name: "Lunch one street back", nameAr: "غداء بالشارع اللي وراء الواجهة", why: "Everything on the harbour front is priced for day-trippers — the places one street behind it are not, and the fish is the same.", whyAr: "كل اللي على الواجهة مسعّر لزوار اليوم — واللي بالشارع اللي وراه لا، ونفس السمك.", category: "food", rating: 4.2, priceBand: 2, startTime: "14:30" },
...
const BURSA_DAYTRIP: CuratedDay = {
  ...
  places: [
    ...
    { name: "Kebapçı İskender", nameAr: "مطعم كبابجي إسكندر", why: "The dish was invented in this family's kitchen in 1867 — order it plain, not the 'special'.", whyAr: "الأكلة اخترعوها بمطبخ هالعائلة سنة ١٨٦٧ — اطلبوها عادية، مو «سبيشال».", category: "food", rating: 4.3, priceBand: 2, startTime: "13:30" },
...
const TBILISI_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Vera and Kiacheli street", nameAr: "فيرا وشارع كياتشيلي", why: "The residential side of the city — book a table on Kiacheli and you'll likely be the only visitors in the room.", whyAr: "الجهة السكنية من المدينة — احجزوا طاولة بكياتشيلي وغالبًا بتكونون الزوار الوحيدين بالمكان.", category: "food", rating: 4.4, priceBand: 2, startTime: "19:00" },
    ],
  },
  {
    key: "tbilisi-slow",
...
const BATUMI_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      ...
      { name: "Batumi fish market", nameAr: "سوق سمك باتومي", why: "Pick your fish downstairs, carry it upstairs, and a kitchen grills it while you sit — you pay the two separately.", whyAr: "اختاروا سمككم تحت واطلعوه فوق، والمطبخ يشويه وأنتم قاعدين — وتدفعون للاثنين منفصل.", category: "food", rating: 4.3, priceBand: 2, startTime: "19:30" },
    ],
  },
  {
