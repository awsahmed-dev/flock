...
const SARAJEVO_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      { name: "Sebilj", nameAr: "سبيل باشتشارشيا", why: "The wooden fountain everyone meets at — drink from it, the local line is that you'll come back to the city if you do.", whyAr: "السبيل الخشبي اللي يتواعد عنده الكل — اشربوا منه، وأهل البلد يقولون إن اللي يشرب منه يرجع للمدينة.", category: "sight", priceBand: 0, startTime: "16:30" },
      { name: "Kazandžiluk", nameAr: "سوق النحّاسين", why: "One narrow lane of coppersmiths still hammering at six in the evening — that noise is the shops working, not a show.", whyAr: "زقاق ضيق فيه نحّاسين لايزالون يطرقون الساعة ستة المسا — الصوت شغل حقيقي مو عرض.", category: "shop", priceBand: 1, startTime: "17:30" },
      { name: "Ćevabdžinica Željo", nameAr: "مطعم چيفابجينيتسا جيليو", why: "Ćevapi in a somun bread with raw onion and kajmak — order by the count of ten, and it is halal, like nearly every grill in this quarter.", whyAr: "چيفابي بخبز الصومون مع بصل نيء وقيمر — اطلبوا بعدد عشرة، وهو حلال مثل تقريبًا كل المشاوي بهالحي.", category: "food", priceBand: 1, startTime: "19:00", dietary: ["halal"] },
    ],
  },
  {
    ...
    places: [
      { name: "Gazi Husrev-beg Mosque", nameAr: "جامع غازي خسرو بك", why: "Built in 1531 and still the city's main mosque — the courtyard fountain and the old clock tower next door keep lunar time, the only one left in the world.", whyAr: "بُني سنة ١٥٣١ ولا يزال جامع المدينة الرئيسي — وشادروان الصحن وبرج الساعة اللي جنبه يضبطون التوقيت القمري، الوحيد الباقي بالعالم.", category: "sight", priceBand: 0, startTime: "09:30" },
      { name: "Morića Han", nameAr: "خان موريتشا", why: "The last surviving caravanserai in the city — walk into the courtyard, sit under the vine, and the traffic outside stops existing.", whyAr: "آخر خان باقٍ بالمدينة — ادخلوا الفناء واقعدوا تحت الدالية وبينقطع صوت الشارع تمامًا.", category: "rest", priceBand: 1, startTime: "11:00" },
      { name: "Aščinica ASDŽ", nameAr: "أشتشينيتسا ASDŽ", why: "Point at the pots in the window: stuffed onions, okra stew, dolma and a bowl of begova čorba — a halal kitchen, and they close when the pots run out in the afternoon.", whyAr: "أشّروا على القدور بالواجهة: بصل محشي ويخنة بامية ودولمة وصحن «بيغوفا تشوربا» — مطبخ حلال، ويسكّرون أول ما تخلص القدور بالعصر.", category: "food", priceBand: 1, startTime: "12:30", dietary: ["halal"] },
      { name: "Latin Bridge", nameAr: "الجسر اللاتيني", why: "The corner beside it is where the First World War started — the bridge is ordinary, the plaque is two sentences, and standing there is the point.", whyAr: "الزاوية اللي جنبه هي وين بدأت الحرب العالمية الأولى — الجسر عادي واللوحة سطرين، والوقوف هناك هو المقصد.", category: "sight", priceBand: 0, startTime: "14:00" },
    ],
  },
  {
    key: "sarajevo-siege",
...
const BAKU_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      { name: "Qız Qalası", nameAr: "برج العذراء", why: "Nobody agrees what this tower was for, in eight hundred years of trying — climb it for the roofs, then argue about it downstairs.", whyAr: "ما أحد متفق على وظيفة هالبرج من ثمانمئة سنة وهم يحاولون — اطلعوه عشان السطوح، وتجادلوا عنه تحت.", category: "sight", priceBand: 1, startTime: "17:00" },
      { name: "İçərişəhər lanes", nameAr: "أزقة المدينة الداخلية", why: "The walled old city is small enough to get lost in for exactly forty minutes — every lane comes out at the wall eventually.", whyAr: "المدينة القديمة المسوّرة صغيرة بحيث تضيعون فيها أربعين دقيقة بالضبط — وكل زقاق يطلعكم على السور بالآخر.", category: "walk", priceBand: 0, startTime: "18:00" },
      { name: "Fountains Square", nameAr: "ساحة النافورات", why: "Where the city comes out after dark, families included, and it stays busy past midnight in summer.", whyAr: "وين تطلع المدينة بعد الظلمة، والعوائل معهم، وتظل مزدحمة لبعد منتصف الليل بالصيف.", category: "walk", priceBand: 0, startTime: "19:30" },
      { name: "Dolma Restaurant Baku", nameAr: "مطعم دولما بباكو", why: "Dolma three ways — vine leaf, aubergine and pepper — with garlic yoghurt, and lamb kufta the size of a fist. Two minutes from the old city gate.", whyAr: "دولمة بثلاث طرق — ورق عنب وباذنجان وفلفل — مع لبن بالثوم، وكفتة غنم بحجم القبضة. دقيقتين من باب المدينة القديمة.", category: "food", priceBand: 2, startTime: "20:30", dietary: ["unverified"] },
    ],
  },
  {
    key: "baku-oldcity",
  ...
  },
  {
    ...
    places: [
      { name: "Ateshgah Fire Temple", nameAr: "معبد النار آتشغاه", why: "A pentagonal caravanserai built round a natural gas vent by Indian merchants — the flame is piped now, and the cells around it are the real thing.", whyAr: "خان خماسي الأضلاع بناه تجار هنود حول فتحة غاز طبيعية — اللهب اليوم موصول بأنبوب، لكن الحجرات حوله أصلية.", category: "sight", priceBand: 1, startTime: "10:30" },
      { name: "Yanar Dag", nameAr: "يانار داغ", why: "A ten-metre stretch of hillside that has been on fire continuously for decades — it is better after dark, and better still in wind.", whyAr: "شريط من المنحدر بطول عشرة أمتار مشتعل بلا انقطاع من عقود — أحلى بعد الظلمة، وأحلى منها بالهوا.", category: "nature", priceBand: 1, startTime: "13:30" },
      { name: "Heydar Aliyev Center", nameAr: "مركز حيدر علييف", why: "Zaha Hadid's building with no straight line anywhere in it — the exterior is free to walk around and is most of the reason people come.", whyAr: "مبنى زها حديد اللي ما فيه ولا خط مستقيم — الخارج مجاني وتقدرون تلفون حوله، وهو أغلب سبب الزيارة.", category: "sight", priceBand: 1, startTime: "16:30" },
      { name: "Sumakh", nameAr: "مطعم سوماخ", why: "Azerbaijani cooking done properly: piti in a sealed clay pot you tear bread into, saffron plov under a pastry crust, and dushbara dumplings you eat by the spoonful.", whyAr: "مطبخ أذربيجاني على أصوله: «بيتي» بقدر فخار مسكّر تفتّون فيه الخبز، وبلوّ بالزعفران تحت قشرة عجين، ودوشبرة صغيرة تاكلونها بالملعقة.", category: "food", priceBand: 2, startTime: "18:30", dietary: ["unverified"] },
    ],
  },
];
...
const MOSTAR_DAYTRIP: CuratedDay = {
  ...
  titleAr: "موستار بيوم",
  places: [
    { name: "Stari Most", nameAr: "الجسر القديم", why: "Two and a half hours from Sarajevo each way — the bridge was shelled to the river bed in 1993 and rebuilt from the stones they dredged back up.", whyAr: "ساعتين ونص من سراييفو بكل اتجاه — الجسر قُصف لين قاع النهر سنة ١٩٩٣ وأُعيد بناؤه من الحجارة اللي طلعوها منه.", category: "sight", priceBand: 0, startTime: "11:00" },
    { name: "Kujundžiluk", nameAr: "سوق الصاغة (كويونجيلوك)", why: "The cobbled bazaar either side of the bridge — the copper worked from shell casings is made here, not imported.", whyAr: "البازار المبلّط على جهتي الجسر — والنحاس المشغول من ظروف القذائف يُصنع هنا، مو مستورد.", category: "shop", priceBand: 1, startTime: "12:00" },
    { name: "Koski Mehmed-Pasha Mosque", nameAr: "جامع كوسكي محمد باشا", why: "Pay the small extra fee and climb the minaret — it is the view of the bridge, the one every photograph of Mostar is taken from.", whyAr: "ادفعوا الزيادة البسيطة واطلعوا المئذنة — هذي هي إطلالة الجسر، ومنها تتصور كل صور موستار.", category: "sight", priceBand: 1, startTime: "13:30" },
    { name: "Blagaj Tekke", nameAr: "تكية بلاغاي", why: "Fifteen minutes out of town: a dervish lodge under a 200-metre cliff, with the Buna river coming out of the rock beneath it.", whyAr: "خمسطعش دقيقة برا البلدة: تكية درويشية تحت جرف بمئتين متر، ونهر البونا يخرج من الصخر تحتها.", category: "sight", priceBand: 1, startTime: "15:30" },
  ],
};
...
const JAJCE_DAYTRIP: CuratedDay = {
  ...
  titleAr: "يايتسه بيوم",
  places: [
    { name: "Pliva Waterfall", nameAr: "شلال بليفا", why: "Two and a half hours west of Sarajevo, and the 20-metre fall is inside the town — one river drops into another in the middle of the street plan.", whyAr: "ساعتين ونص غرب سراييفو، والشلال بعشرين متر داخل البلدة نفسها — نهر يصب بنهر بقلب مخطط الشوارع.", category: "nature", priceBand: 1, startTime: "11:30" },
    ...
    { name: "Pliva Watermills", nameAr: "طواحين بليفا", why: "Twenty small wooden mills standing in the shallows between the two Pliva lakes — they are miniature, they are real, and they still turn.", whyAr: "عشرين طاحونة خشبية صغيرة واقفة بالماي الضحل بين بحيرتي بليفا — مصغّرة وحقيقية ولا تزال تدور.", category: "sight", priceBand: 0, startTime: "15:00" },
  ],
};
...
const GOBUSTAN_DAYTRIP: CuratedDay = {
  ...
  places: [
    { name: "Bibi-Heybat Mosque", nameAr: "مسجد بيبي هيبت", why: "Twenty minutes down the Gobustan road: the original was dynamited in 1936 and this rebuild opened in 1998 — stop on the way out, not the way back.", whyAr: "عشرين دقيقة على طريق قوبوستان: الأصلي نُسف سنة ١٩٣٦ وهذا البناء الجديد فتح سنة ١٩٩٨ — قفوا عنده بالذهاب مو بالرجعة.", category: "sight", priceBand: 0, startTime: "09:30" },
    { name: "Gobustan Rock Art Reserve", nameAr: "محمية قوبوستان للنقوش الصخرية", why: "Six thousand carvings on the boulders, the oldest around 12,000 years old — take the marked trail, the best panels are past the first cluster.", whyAr: "ستة آلاف نقش على الصخور، وأقدمها عمره حوالي ١٢ ألف سنة — امشوا المسار المعلّم، وأحلى اللوحات بعد أول تجمّع.", category: "sight", priceBand: 1, startTime: "11:00" },
    { name: "Gobustan Museum", nameAr: "متحف قوبوستان", why: "Do it after the rocks, not before — it explains what you have just walked past, and in the other order it explains nothing.", whyAr: "خلوه بعد الصخور مو قبلها — يشرح لكم اللي مريتوا عليه، وبالترتيب المعكوس ما يشرح شي.", category: "sight", priceBand: 1, startTime: "13:00" },
    { name: "Gobustan mud volcanoes", nameAr: "براكين الطين بقوبوستان", why: "Cold grey mud burping out of metre-high cones in open desert — the road in destroys ordinary cars, so it's the old Ladas at the gate or nothing.", whyAr: "طين رمادي بارد يتفقع من أقماع بارتفاع متر بصحرا مفتوحة — والطريق يكسّر السيارات العادية، فإما «لادا» قديمة عند البوابة أو لا شي.", category: "nature", priceBand: 1, startTime: "15:00" },
  ],
};
