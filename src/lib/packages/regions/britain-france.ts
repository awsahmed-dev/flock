...
const LONDON_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Borough Market", nameAr: "سوق بورو", why: "Go for lunch, not for shopping — the cooked stalls at the back are the market, the gift jars at the front are not.", whyAr: "روحوا للغداء مو للتسوق — بسطات الطبخ بالخلف هي السوق، والمرطبانات بالواجهة لا.", category: "food", rating: 4.5, priceBand: 2, startTime: "13:30" },
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Edgware Road", nameAr: "شارع إدجوير", why: "A kilometre of Lebanese, Egyptian and Iraqi kitchens open past midnight — the further north you walk, the less it's a tourist street.", whyAr: "كيلو كامل مطابخ لبنانية ومصرية وعراقية تفتح لبعد منتصف الليل — كل ما طلعتم شمال، قلّ كونه شارع سياح.", category: "food", rating: 4.3, priceBand: 2, startTime: "19:00" },
    ],
  },
  {
    key: "london-west",
    ...
    places: [
      ...
      { name: "Camden Market", nameAr: "سوق كامدن", why: "The lock end is food stalls and the stable end is everything else — eat at the first, browse the second, ignore the middle.", whyAr: "جهة الهويس أكل وجهة الإسطبلات كل شي ثاني — كلوا بالأولى وتفرجوا بالثانية وتجاوزوا اللي بينهم.", category: "food", rating: 4.3, priceBand: 1, startTime: "15:00" },
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Greenwich Market", nameAr: "سوق غرينتش", why: "Covered, small, and mostly food at lunchtime — twenty minutes and you've seen it, which is the right amount.", whyAr: "مسقوف وصغير وأغلبه أكل وقت الغداء — عشرين دقيقة وتكونون شفتوه، وهذا الوقت المناسب.", category: "food", rating: 4.3, priceBand: 1, startTime: "13:00" },
...
const PARIS_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Place Vendôme", nameAr: "ساحة فاندوم", why: "A square built to one design by one architect — stand in the middle and every façade is the same façade, which is the whole joke.", whyAr: "ساحة مبنية بتصميم واحد ومعماري واحد — وقفوا بالنص وبتلقون كل الواجهات واجهة وحدة، وهذي النكتة كلها.", category: "walk", rating: 4.5, priceBand: 0, startTime: "15:00" },
      { name: "Galerie Vivienne", nameAr: "رواق فيفيان", why: "An 1823 glass-roofed arcade with a mosaic floor, two streets off the noise — Paris had shopping malls before anyone else and this is the proof.", whyAr: "رواق زجاجي من ١٨٢٣ بأرضية فسيفساء، شارعين بس بعيد عن الضجة — باريس سبقت الكل بالمولات، وهذا الدليل.", category: "shop", rating: 4.6, priceBand: 1, startTime: "16:30" },
    ],
  },
  {
    ...
    places: [
      ...
      { name: "Rue des Martyrs", nameAr: "شارع الشهداء", why: "The market street the hill actually shops on — bakers, cheese, fruit, and no view of anything, which is why it's still real.", whyAr: "شارع السوق اللي تتسوق منه التلة فعلًا — مخابز وأجبان وفواكه وبدون أي إطلالة، وعشان كذا لايزال حقيقي.", category: "food", rating: 4.5, priceBand: 1, startTime: "15:00" },
    ],
  },
  {
    key: "paris-marais",
    ...
    places: [
      ...
      { name: "Rue des Rosiers", nameAr: "شارع الروزييه", why: "Falafel counters with a queue down the street at four in the afternoon — join the shorter one, they are all the same recipe.", whyAr: "محلات فلافل وطوابيرها نازلة بالشارع الساعة أربعة العصر — ادخلوا الأقصر، كلهم نفس الوصفة.", category: "food", rating: 4.4, priceBand: 1, startTime: "16:00" },
    ],
  },
  {
    key: "paris-leftbank",
    ...
    places: [
      ...
      { name: "Rue Mouffetard", nameAr: "شارع موفتار", why: "One of the oldest streets in the city, downhill all the way, and the market end at the bottom is where you buy dinner.", whyAr: "من أقدم شوارع المدينة، ونازل طول الطريق، وطرف السوق بأسفله هو وين تشترون العشا.", category: "food", rating: 4.4, priceBand: 1, startTime: "17:00" },
    ],
  },
];
...
const OXFORD_DAYTRIP: CuratedDay = {
  ...
  places: [
    ...
    { name: "Covered Market", nameAr: "السوق المسقوف", why: "Trading since 1774, two minutes off the high street — lunch here costs a third of what the college-facing cafés charge.", whyAr: "شغّال من ١٧٧٤ وعلى بعد دقيقتين من الشارع الرئيسي — الغداء هنا بثلث سعر المقاهي اللي قبال الكليات.", category: "food", rating: 4.4, priceBand: 1, startTime: "13:00" },
...
const VERSAILLES_DAYTRIP: CuratedDay = {
  ...
  places: [
    ...
    { name: "Marché Notre-Dame", nameAr: "سوق نوتردام", why: "The town's own market square, ten minutes from the gates — Tuesdays, Fridays and Sundays, and nobody on the tour buses knows it's there.", whyAr: "ساحة سوق البلدة نفسها، على بعد عشر دقايق من البوابات — الثلاثاء والجمعة والأحد، وما أحد من باصات الجولات يدري عنها.", category: "food", rating: 4.4, priceBand: 1, startTime: "17:00" },
  ],
};
