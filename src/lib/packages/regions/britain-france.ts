...
const LONDON_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      { name: "Westminster Bridge", nameAr: "جسر ويستمنستر", why: "Stand on the south end, not the north — that's the side the clock tower is photographed from, and it's free.", whyAr: "وقفوا بالطرف الجنوبي مو الشمالي — من هالجهة تتصور ساعة البرج، وببلاش.", category: "sight", priceBand: 0, startTime: "16:30" },
      { name: "St James's Park", nameAr: "حديقة سانت جيمس", why: "Cut through it rather than around it — the bridge in the middle looks straight down the lake at the palace.", whyAr: "اقطعوها من النص مو من حولها — الجسر اللي بوسطها يطل على البحيرة والقصر بخط واحد.", category: "nature", priceBand: 0, startTime: "17:30" },
      { name: "Trafalgar Square", nameAr: "ساحة ترافلغار", why: "The National Gallery behind it is free and open late on Fridays — one room is a better first night than a whole museum.", whyAr: "المعرض الوطني اللي خلفها مجاني ويفتح متأخر يوم الجمعة — قاعة وحدة أحلى أول ليلة من متحف كامل.", category: "sight", priceBand: 0, startTime: "19:00" },
      { name: "Dishoom Covent Garden", nameAr: "ديشوم كوفنت غاردن", why: "Bombay café food eight minutes from the square — black daal cooked overnight, chicken ruby, pau bhaji and endless chai. No bookings after five, so leave your name and wait. Bacon is on the breakfast menu.", whyAr: "أكل مقاهي بومباي على بعد ثمان دقايق من الساحة — دال أسود مطبوخ طول الليل، ودجاج «روبي»، وباو باجي، وشاي ما ينتهي. ما يحجزون بعد الخامسة، فاتركوا اسمكم وانتظروا. وبقائمة الفطور لحم خنزير.", category: "food", priceBand: 2, startTime: "20:30", dietary: ["vegetarian", "pork-served"] },
    ],
  },
  {
    key: "london-city",
    ...
    places: [
      { name: "Tower of London", nameAr: "برج لندن", why: "Join the free Yeoman Warder tour at the gate — forty minutes, told by someone who lives inside the walls.", whyAr: "انضموا لجولة الحرس المجانية عند البوابة — أربعين دقيقة يحكيها واحد ساكن داخل الأسوار.", category: "sight", priceBand: 3, startTime: "09:00" },
      { name: "Tower Bridge", nameAr: "جسر البرج", why: "The glass floor in the high walkway puts the road forty metres under your feet — check the lift times before you buy.", whyAr: "الأرضية الزجاجية بالممر العلوي تخلي الشارع أربعين متر تحت أرجلكم — شوفوا أوقات فتح الجسر قبل ما تشترون.", category: "sight", priceBand: 2, startTime: "12:00" },
      { name: "Borough Market", nameAr: "سوق بورو", why: "Go for lunch, not for shopping — the cooked stalls at the back are the market: grilled cheese sandwiches, fish from the coast that morning, curries by the box. The gift jars at the front are not.", whyAr: "روحوا للغداء مو للتسوق — بسطات الطبخ بالخلف هي السوق: سندويشات جبن مشوية، وسمك جا من الساحل نفس الصباح، وكاري بالعلبة. والمرطبانات بالواجهة لا.", category: "food", priceBand: 2, startTime: "13:30", dietary: ["seafood", "pork-served"] },
      { name: "St Paul's Cathedral", nameAr: "كاتدرائية القديس بولس", why: "Cross the Millennium Bridge towards it at dusk — the dome grows the whole way and the walk costs nothing.", whyAr: "اقطعوا جسر الميلينيوم باتجاهها وقت المغرب — القبة تكبر طول الطريق والمشية ببلاش.", category: "sight", priceBand: 2, startTime: "16:00" },
    ],
  },
  {
    key: "london-museums",
    ...
    places: [
      { name: "Natural History Museum", nameAr: "متحف التاريخ الطبيعي", why: "Free, and the building is the exhibit — enter by the Exhibition Road door and you skip the queue on Cromwell Road entirely.", whyAr: "مجاني، والمبنى نفسه هو المعروض — ادخلوا من باب شارع إكزيبيشن وبتتجاوزون طابور كرومويل كامل.", category: "sight", priceBand: 0, startTime: "10:00" },
      { name: "Victoria and Albert Museum", nameAr: "متحف فيكتوريا وألبرت", why: "Next door and also free — the Islamic Middle East gallery holds the Ardabil carpet, the oldest dated carpet in the world.", whyAr: "جنبه وبعد مجاني — قاعة الشرق الأوسط الإسلامي فيها سجادة أردبيل، أقدم سجادة مؤرخة بالعالم.", category: "sight", priceBand: 0, startTime: "13:00" },
      { name: "Hyde Park and the Serpentine", nameAr: "هايد بارك والسربنتاين", why: "Rent a pedalo for half an hour — it's the one thing in central London that costs less than the coffee next to it.", whyAr: "استأجروا قارب دواسات نص ساعة — الشي الوحيد بوسط لندن اللي أرخص من القهوة اللي جنبه.", category: "nature", priceBand: 1, startTime: "15:30" },
      { name: "Edgware Road", nameAr: "شارع إدجوير", why: "A kilometre of Lebanese, Egyptian and Iraqi kitchens open past midnight — mixed grills, mezze by the dozen, fresh bread and knafeh — and the further north you walk, the less it's a tourist street.", whyAr: "كيلو كامل مطابخ لبنانية ومصرية وعراقية تفتح لبعد منتصف الليل — مشاوي مشكلة ومازات بالجملة وخبز طازج وكنافة — وكل ما طلعتم شمال، قلّ كونه شارع سياح.", category: "food", priceBand: 2, startTime: "19:00", dietary: ["unverified"] },
    ],
  },
  {
    key: "london-west",
    ...
    places: [
      { name: "Portobello Road Market", nameAr: "سوق بورتوبيلو رود", why: "Saturday is the full market and also the crush — any other morning you get the painted houses without the queue for them.", whyAr: "السبت هو السوق الكامل وهو الزحمة — أي صباح ثاني تلقون البيوت الملونة بدون طابور عليها.", category: "shop", priceBand: 1, startTime: "10:00" },
      { name: "Little Venice", nameAr: "البندقية الصغيرة", why: "Houseboats where two canals meet — the towpath from here to Camden is fifty flat minutes through the back of the zoo.", whyAr: "بيوت عائمة عند ملتقى قناتين — وممشى القناة من هنا لكامدن خمسين دقيقة مستوية تمر خلف حديقة الحيوان.", category: "walk", priceBand: 0, startTime: "13:00" },
      { name: "Camden Market", nameAr: "سوق كامدن", why: "The lock end is fifty food stalls — Ethiopian platters, Venezuelan arepas, dumplings by the steamer basket — and the stable end is everything else. Eat at the first, browse the second, ignore the middle.", whyAr: "جهة الهويس فيها خمسين بسطة أكل — صواني إثيوبية وأريباس فنزويلية وفطائر مبخّرة بالسلة — وجهة الإسطبلات كل شي ثاني. كلوا بالأولى وتفرجوا بالثانية وتجاوزوا اللي بينهم.", category: "food", priceBand: 1, startTime: "15:00", dietary: ["unverified"] },
      { name: "Primrose Hill", nameAr: "تلة بريمروز", why: "Ten minutes uphill from Camden for the skyline everyone films — there's a stone at the top naming the towers you're looking at.", whyAr: "عشر دقايق طلوع من كامدن للأفق اللي يصوره الكل — وفوق حجر مكتوب عليه أسماء الأبراج اللي تشوفونها.", category: "nature", priceBand: 0, startTime: "18:00" },
    ],
  },
  {
...
const PARIS_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      { name: "Musée d'Orsay", nameAr: "متحف أورسيه", why: "A railway station turned museum — go to the fifth floor first, before the Impressionist rooms fill, then come down through everything else.", whyAr: "محطة قطار تحولت متحف — اطلعوا الدور الخامس أول قبل ما تنزحم قاعات الانطباعيين، وبعدها انزلوا على الباقي.", category: "sight", priceBand: 2, startTime: "09:30" },
      { name: "Jardin du Luxembourg", nameAr: "حديقة لوكسمبورغ", why: "Rent a wooden sailboat at the big pond and push it with a stick — it has cost a euro or two and entertained children since 1927.", whyAr: "استأجروا قارب شراعي خشبي عند البركة الكبيرة وادفعوه بعصا — بيورو أو اثنين، ويسلي العيال من ١٩٢٧.", category: "nature", priceBand: 1, startTime: "12:30" },
      { name: "Grande Mosquée de Paris", nameAr: "جامع باريس الكبير", why: "Built in 1926 in Moroccan style, with a tiled courtyard and a tea room open to anyone — mint tea and a place to actually sit down.", whyAr: "بُني سنة ١٩٢٦ على الطراز المغربي، وفيه صحن مبلّط ومقهى مفتوح للجميع — شاي بالنعناع ومكان تقعدون فيه فعلًا.", category: "sight", priceBand: 1, startTime: "15:00" },
      { name: "Rue Mouffetard", nameAr: "شارع موفتار", why: "One of the oldest streets in the city, downhill all the way, and the market end at the bottom is where you buy dinner — crêpes off a griddle, roast chicken and potatoes from under it, cheese by the wedge. The charcuterie windows are pork.", whyAr: "من أقدم شوارع المدينة، ونازل طول الطريق، وطرف السوق بأسفله هو وين تشترون العشا — كريب من على الصاج، ودجاج مشوي وبطاطا من تحته، وجبن بالقطعة. وواجهات «الشاركوتري» لحم خنزير.", category: "food", priceBand: 1, startTime: "17:00", dietary: ["vegetarian", "pork-served"] },
    ],
  },
];
