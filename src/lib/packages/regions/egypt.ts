...
const CAIRO_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      { name: "Pyramids of Giza", nameAr: "أهرامات الجيزة", why: "Be at the gate when it opens. By eleven you are sharing Khufu with four thousand people and the light has gone flat white.", whyAr: "كونوا عند البوابة مع الافتتاح. بعد الحادية عشر بتتقاسمون خوفو مع أربعة آلاف واحد والضوء يصير أبيض مسطح.", category: "sight", priceBand: 2, startTime: "08:00" },
      { name: "Great Sphinx of Giza", nameAr: "أبو الهول", why: "Walk down to it instead of taking the horse — it is eight minutes, and the approach through the valley temple is how it was built to be seen.", whyAr: "انزلوا له مشي بدل ما تاخذون حصان — ثمان دقايق، والدخول من معبد الوادي هو الطريقة اللي بُني عشان تشوفونه فيها.", category: "sight", priceBand: 0, startTime: "10:30" },
      { name: "9 Pyramids Lounge", nameAr: "ناين بيراميدز لاونج", why: "The only kitchen inside the plateau fence: grilled kofta, koshary and hibiscus over ice, at tables where all nine pyramids line up in one window.", whyAr: "المطبخ الوحيد داخل سور الهضبة: كفتة مشوية وكشري وكركديه على ثلج، وطاولات تتصف قدامها الأهرامات التسعة بمنظر واحد.", category: "food", priceBand: 2, startTime: "12:00", dietary: ["halal"] },
      { name: "Grand Egyptian Museum", nameAr: "المتحف المصري الكبير", why: "Give it four hours and start on the grand staircase — Tutankhamun's five thousand pieces are all in one room here for the first time since they came out of the ground.", whyAr: "أعطوه أربع ساعات وابدأوا من الدرج الكبير — كنز توت عنخ آمون كامل، خمسة آلاف قطعة، بقاعة وحدة لأول مرة من يوم طلعت من الأرض.", category: "sight", priceBand: 2, startTime: "13:30" },
    ],
  },
  {
    key: "cairo-fatimid",
    ...
    places: [
      { name: "Al-Azhar Mosque", nameAr: "الجامع الأزهر", why: "A thousand years of teaching around one courtyard — sit against a column in the sahn for ten minutes before you go anywhere else in this city.", whyAr: "ألف سنة تدريس حول صحن واحد — اقعدوا يمّ عمود بالصحن عشر دقايق قبل ما تروحون أي مكان ثاني بهالمدينة.", category: "sight", priceBand: 0, startTime: "09:30" },
      { name: "Farahat", nameAr: "مطعم فرحات", why: "Pigeon stuffed with freekeh, or half a chicken off the grill and a plate of tahini, at metal tables in a lane off Al-Azhar — they cook in the street and you eat in it.", whyAr: "حمام محشي فريك، أو نص فرخة من على الفحم وصحن طحينة، على طاولات حديد بزقاق جنب الأزهر — يطبخون بالشارع وتاكلون فيه.", category: "food", priceBand: 1, startTime: "13:00", dietary: ["halal"] },
      { name: "Al-Azhar Park", nameAr: "حديقة الأزهر", why: "Built on a five-hundred-year-old rubbish mound; the upper terrace looks straight across the whole medieval skyline as the sun drops behind it.", whyAr: "مبنية فوق تلة زبالة عمرها خمسمية سنة؛ والشرفة العليا تطل على خط المدينة المملوكي كامل والشمس تنزل خلفه.", category: "nature", priceBand: 1, startTime: "16:30" },
      { name: "Al-Muizz Street", nameAr: "شارع المعز لدين الله", why: "Go after dark, when it is lit and closed to cars — a kilometre of Fatimid and Mamluk façades, and you can walk inside most of them.", whyAr: "روحوا بعد الظلام، لما يضوي ويتسكّر بوجه السيارات — كيلو واجهات فاطمية ومملوكية، وأغلبها تقدرون تدخلونه.", category: "walk", priceBand: 0, startTime: "18:30" },
    ],
  },
  {
    key: "cairo-citadel",
...
const LUXOR_DAYS: CuratedDay[] = [
  {
    ...
    titleAr: "البر الشرقي",
    places: [
      { name: "Karnak Temple", nameAr: "معبد الكرنك", why: "Thirty pharaohs each added to it over two thousand years — go straight to the hypostyle hall at opening and stand in it alone for ten minutes.", whyAr: "ثلاثين فرعون كل واحد زاد عليه على مدى ألفين سنة — روحوا لقاعة الأعمدة مع الافتتاح واوقفوا فيها لحالكم عشر دقايق.", category: "sight", priceBand: 2, startTime: "08:00" },
      { name: "Luxor Museum", nameAr: "متحف الأقصر", why: "Small, cold and perfectly lit — an hour here teaches you more than a whole day at Karnak, and almost nobody bothers with it.", whyAr: "صغير وبارد وإضاءته مظبوطة — ساعة فيه تعلمكم أكثر من يوم كامل بالكرنك، وبالكاد أحد يهتم فيه.", category: "sight", priceBand: 1, startTime: "11:30" },
      { name: "Sofra Restaurant", nameAr: "مطعم سفرة", why: "Molokhia, stuffed pigeon and lamb tagine out of clay pots, in a 1930s house two streets back from the corniche — sit upstairs on the floor cushions.", whyAr: "ملوخية وحمام محشي وطواجن لحم بالفخار، ببيت من الثلاثينات على بعد شارعين من الكورنيش — اقعدوا فوق على المساند الأرضية.", category: "food", priceBand: 1, startTime: "14:00", dietary: ["unverified"] },
      { name: "Luxor Temple", nameAr: "معبد الأقصر", why: "Come back to it after dark — it is the one great temple lit at night, and the avenue of sphinxes runs out of it straight into the modern town.", whyAr: "ارجعوا له بعد الظلام — المعبد الكبير الوحيد اللي ينوّر بالليل، وطريق الكباش يطلع منه لداخل البلد الحديثة مباشرة.", category: "sight", priceBand: 2, startTime: "18:00" },
    ],
  },
  {
    key: "luxor-kings",
  ...
  },
  {
    ...
    places: [
      { name: "Deir el-Medina", nameAr: "دير المدينة", why: "The village where the men who cut the royal tombs lived, with their own small tombs on the slope above — better painted than most of the kings' are.", whyAr: "القرية اللي عاش فيها الرجال اللي حفروا مقابر الملوك، وفوقها بالمنحدر مقابرهم الصغيرة — ملونة أحسن من أغلب مقابر الملوك نفسها.", category: "sight", priceBand: 1, startTime: "08:30" },
      { name: "Medinet Habu", nameAr: "مدينة هابو", why: "The colour is still on the ceilings here because hardly anyone comes — this is what Karnak looked like when it was painted.", whyAr: "الألوان لسا على السقوف هنا لأن بالكاد أحد يجي — كذا كان شكل الكرنك وهو ملوّن.", category: "sight", priceBand: 1, startTime: "11:00" },
      { name: "Nour El Balad", nameAr: "نور البلد", why: "A west-bank house with a roof terrace over the sugarcane: tagines of duck and okra, aubergine with tahini, and everything on the table comes off the family's own land.", whyAr: "بيت بالبر الغربي وسطحه يطل على قصب السكر: طواجن بط وبامية، وباذنجان بالطحينة، وكل اللي على السفرة من أرض العيلة نفسها.", category: "food", priceBand: 1, startTime: "13:00", dietary: ["halal"] },
      { name: "Banana Island", nameAr: "جزيرة الموز", why: "Twenty minutes upriver by felucca — a farm island of banana and mango where the tea arrives with sugarcane you cut yourself.", whyAr: "عشرين دقيقة عكس التيار بالفلوكة — جزيرة مزارع موز ومانجو، والشاي يجيكم مع قصب تقطعونه بأيديكم.", category: "nature", priceBand: 1, startTime: "16:00" },
    ],
  },
];
...
const ALEXANDRIA_DAYTRIP: CuratedDay = {
  ...
  places: [
    { name: "Bibliotheca Alexandrina", nameAr: "مكتبة الإسكندرية", why: "Two and a half hours by train from Ramses, and you can walk straight into the reading room — eleven terraced floors under one tilted disc.", whyAr: "ساعتين ونص بالقطار من رمسيس، وتدخلون قاعة المطالعة مباشرة — إحدى عشر مدرج تحت قرص مايل واحد.", category: "sight", priceBand: 1, startTime: "10:30" },
    { name: "Citadel of Qaitbay", nameAr: "قلعة قايتباي", why: "Built out of the rubble of the lighthouse that stood on this exact rock — you can still pick out granite columns laid flat inside the walls.", whyAr: "مبنية من أنقاض الفنار اللي كان واقف على نفس هالصخرة — ولسا تقدرون تميزون أعمدة جرانيت مسطحة داخل الجدران.", category: "sight", priceBand: 1, startTime: "13:00" },
    { name: "Abu al-Abbas al-Mursi Mosque", nameAr: "جامع المرسي أبو العباس", why: "The city's main mosque, cream stone on an open square by the fishing harbour — pray Dhuhr here and eat two streets behind it.", whyAr: "جامع المدينة الرئيسي، حجر كريمي على ساحة مفتوحة عند ميناء الصيد — صلوا الظهر فيه وكلوا بشارعين خلفه.", category: "sight", priceBand: 0, startTime: "14:30" },
    { name: "Montaza Gardens", nameAr: "حدائق المنتزه", why: "The old royal gardens at the far east end of the Corniche — pine trees running down to a private bay, and a fraction of the crowd of the city beaches.", whyAr: "الحدايق الملكية القديمة بأقصى شرق الكورنيش — صنوبر ينزل لخليج خاص، وزحمة أقل بكثير من شواطئ المدينة.", category: "nature", priceBand: 1, startTime: "17:00" },
  ],
};
...
const FAYOUM_DAYTRIP: CuratedDay = {
  ...
  titleAr: "الفيوم بيوم",
  places: [
    { name: "Wadi El Rayan waterfalls", nameAr: "شلالات وادي الريان", why: "The only waterfalls in Egypt, and they exist by accident — drainage water spilling from one desert lake into the one below it.", whyAr: "الشلالات الوحيدة بمصر، وموجودة بالغلط — ماء صرف ينزل من بحيرة صحراوية للبحيرة اللي تحتها.", category: "nature", priceBand: 1, startTime: "11:00" },
    { name: "Wadi Al-Hitan", nameAr: "وادي الحيتان", why: "Forty-million-year-old whale skeletons lying in open desert exactly where they died — the trail is three kilometres and there is no shade on any of it.", whyAr: "هياكل حيتان عمرها أربعين مليون سنة مرمية بالصحرا المفتوحة بنفس مكان ما ماتت — المسار ثلاثة كيلو وما فيه ظل ولا بمتر منه.", category: "nature", priceBand: 2, startTime: "13:30" },
    { name: "Tunis Village", nameAr: "قرية تونس", why: "A pottery village on the ridge above Lake Qarun — the workshops will put the children on a wheel, and half of them serve lunch as well.", whyAr: "قرية فخار على الحافة فوق بحيرة قارون — والورش تقعّد العيال على الدولاب، ونصها يقدم غدا كمان.", category: "shop", priceBand: 1, startTime: "16:30" },
  ],
};
