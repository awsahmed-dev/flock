...
const AL_AIN_DAYTRIP: CuratedDay = {
  ...
  places: [
    ...
    { name: "Al Jahili Fort", nameAr: "قلعة الجاهلي", why: "Mud brick from 1891, and the permanent Thesiger photography room inside is free and much better than that sounds.", whyAr: "طين وطوب من ١٨٩١، وغرفة صور ثيسيجر الدائمة جوّاها مجانية وأحلى بكثير مما يوحي الوصف.", category: "sight", rating: 4.5, priceBand: 0, startTime: "11:30" },
    { name: "Green Mubazzarah", nameAr: "المبزرة الخضراء", why: "Hot springs at the foot of the mountain where Emirati families spread carpets on the grass from four o'clock onwards — bring your own and join in.", whyAr: "عيون حارة عند سفح الجبل والعوايل الإماراتية تفرش على العشب من الساعة أربع وطالع — خذوا فرشتكم واقعدوا معهم.", category: "rest", rating: 4.4, priceBand: 0, startTime: "16:00" },
    { name: "Jebel Hafeet", nameAr: "جبل حفيت", why: "Twelve kilometres of switchbacks up to 1,240 metres — time it for sunset and stop at the upper car park, not the hotel at the summit.", whyAr: "اثنا عشر كيلو لفات لين ارتفاع ١٢٤٠ متر — رتبوها على الغروب وقفوا بالمواقف العليا مو عند فندق القمة.", category: "nature", rating: 4.7, priceBand: 0, startTime: "17:30" },
  ],
};
