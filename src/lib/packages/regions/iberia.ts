...
const LISBON_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Pastéis de Belém", nameAr: "باشتيش دي بيلين", why: "Custard tarts baked to a monastery recipe and handed over still hot, with cinnamon to shake on yourself — ignore the takeaway line down the street and go inside, the back rooms seat 400 and are usually half empty.", whyAr: "تارت كسترد بوصفة دير قديم يعطونكم إياها وهي سخنة، ومعها قرفة ترشونها بأنفسكم — لا تدخلون طابور السفري بالشارع وادخلوا جوّا، القاعات الخلفية تسع ٤٠٠ وغالبًا نص فاضية.", category: "food", rating: 4.5, priceBand: 1, startTime: "11:30", dietary: ["vegetarian"] },
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Mouraria", nameAr: "حي الموراريا", why: "The Moorish quarter, and still the immigrant quarter — Bengali and Pakistani kitchens doing biryani and grilled chicken on and around Rua do Benformoso, most of them halal and saying so at the door.", whyAr: "الحي المغاربي، ولا يزال حي المهاجرين — مطابخ بنغالية وباكستانية تسوّي برياني ودجاج مشوي بشارع بينفورموزو وحواليه، وأغلبها حلال ومكتوبة على الباب.", category: "food", rating: 4.3, priceBand: 1, startTime: "13:00", dietary: ["halal"] },
...
const PORTO_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      ...
      { name: "Mercado Beira-Rio", nameAr: "سوق بيرا-ريو", why: "A covered food hall on the Gaia quay at the foot of the bridge — grilled sardines, salt-cod fritters and custard tarts from twenty counters, and the terrace outside has the whole of Porto facing you at sunset.", whyAr: "قاعة أكل مسقوفة على رصيف غايا عند قدم الجسر — سردين مشوي وكرات باكالاو وتارت كسترد من عشرين طاولة، والشرفة برا قبالها بورتو كاملة وقت الغروب.", category: "food", rating: 4.4, priceBand: 1, startTime: "18:15", dietary: ["seafood", "pork-served"] },
    ],
  },
  {
    key: "porto-clerigos",
    ...
    places: [
      ...
      { name: "Mercado do Bolhão", nameAr: "سوق بولياو", why: "Reopened in 2022 in its own restored building — the ground-floor stalls are the real market, and the upstairs counters do grilled fish, soups and cheese plates at market prices.", whyAr: "فتح من جديد سنة ٢٠٢٢ بمبناه المرمّم — بسطات الدور الأرضي هي السوق الحقيقي، والطاولات فوق تقدم سمك مشوي وشوربات وأطباق جبن بأسعار السوق.", category: "food", rating: 4.4, priceBand: 1, startTime: "14:00", dietary: ["seafood", "pork-served"] },
    ],
  },
  {
    key: "porto-foz",
    ...
    places: [
      ...
      { name: "Rua Heróis de França", nameAr: "شارع إيرويش دي فرانسا", why: "Matosinhos grills its fish on the pavement down this whole street — pick by the smoke, not by the menu.", whyAr: "ماتوزينيوش تشوي سمكها على الرصيف بطول هالشارع — اختاروا بالدخان، مو بالقائمة.", category: "food", rating: 4.4, priceBand: 2, startTime: "15:30", dietary: ["seafood"] },
    ],
  },
];
