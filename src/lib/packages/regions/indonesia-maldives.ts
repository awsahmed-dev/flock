...
const UBUD_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      { name: "Campuhan Ridge Walk", nameAr: "ممشى حافة تشامبوهان", why: "Ninety minutes from the airport and then this: a paved spine between two river valleys with no traffic on it, and it is the only hour of the day under 30 degrees.", whyAr: "ساعة ونص من المطار وبعدها هذا: ممشى مرصوف على ظهر بين واديين وما فيه سيارات، وهي الساعة الوحيدة باليوم تحت الثلاثين درجة.", category: "walk", priceBand: 0, startTime: "16:00" },
      { name: "Ubud Palace", nameAr: "قصر أوبود", why: "The legong dance in the palace courtyard starts at 7:30 and the tickets are sold at the gate from six — sit on the left, the gamelan orchestra is on the right.", whyAr: "رقصة الليغونغ بفناء القصر تبدأ ٧:٣٠ والتذاكر تنباع عند البوابة من الساعة ستة — اقعدوا على اليسار، فرقة الغاميلان على اليمين.", category: "sight", priceBand: 1, startTime: "18:00" },
      { name: "Fair Warung Balé", nameAr: "فير وارونغ بالي", why: "Dinner after the dance at a warung that puts what it makes into a free clinic up the road — nasi campur, chicken sate, and it is still open when the palace empties.", whyAr: "عشا بعد الرقصة بوارونغ يحوّل أرباحه لعيادة مجانية بنفس الشارع — ناسي تشامبور وسيخ دجاج، ولا زال مفتوح لما يفضى القصر.", category: "food", priceBand: 1, startTime: "20:45", dietary: ["unverified"] },
    ],
  },
  {
    key: "ubud-terraces",
...
const SEMINYAK_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    titleAr: "جروف الجنوب",
    places: [
      { name: "Uluwatu Temple", nameAr: "معبد أولواتو", why: "Seventy metres of cliff straight down to the sea with a temple on the lip of it — hold on to your sunglasses, the monkeys here are professionals.", whyAr: "سبعين متر جرف نازل عمودي على البحر وفوق حافته معبد — امسكوا نظاراتكم زين، قرود هالمكان محترفة.", category: "sight", priceBand: 1, startTime: "10:00" },
      { name: "Padang Padang Beach", nameAr: "شاطئ بادانغ بادانغ", why: "You reach it through a crack in the rock and down a staircase — it is small, and the entrance is exactly why it is worth the steps.", whyAr: "توصلونه من شق بالصخر وبعده درج نازل — صغير، ومدخله بالضبط هو اللي يخلي الدرج يستاهل.", category: "nature", priceBand: 1, startTime: "12:30" },
      { name: "Melasti Beach", nameAr: "شاطئ ميلاستي", why: "A road cut down through white limestone cliffs to a flat turquoise bay — the descent is the photograph, and the water is the calmest in the south.", whyAr: "طريق محفور بين جروف جيرية بيضاء ينزل لخليج فيروزي هادي — النزلة هي الصورة، والماء أهدأ ماء بالجنوب.", category: "nature", priceBand: 0, startTime: "15:00" },
      { name: "Jimbaran Bay", nameAr: "خليج جيمباران", why: "Tables on the sand, fish chosen by weight, and planes coming in low over the bay — agree the price per kilo before they put it on the grill.", whyAr: "طاولات على الرمل، وسمك تختارونه بالوزن، والطيارات تعدي واطية فوق الخليج — اتفقوا على سعر الكيلو قبل ما يحطونه على الجمر.", category: "food", priceBand: 2, startTime: "18:00", dietary: ["seafood", "unverified"] },
    ],
  },
];
...
const MALDIVES_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      { name: "Banana Reef", nameAr: "شعاب البنانا", why: "The first reef anyone dived in the Maldives, and still the one to snorkel — go on the morning boat, before the current turns and the visibility drops.", whyAr: "أول شعاب غاص فيها أحد بالمالديف، ولا زالت الأفضل للسنوركل — روحوا بقارب الصباح، قبل ما ينقلب التيار وتقل الرؤية.", category: "nature", priceBand: 2, startTime: "08:30" },
      { name: "Kuda Bandos", nameAr: "كودا باندوس", why: "An uninhabited picnic island twenty minutes out — sand, shade, a reef off the end of it, and no building. Take water; there is nothing to buy.", whyAr: "جزيرة خالية للنزهة على بعد عشرين دقيقة — رمل وظل وشعاب بطرفها وما فيه أي مبنى. خذوا معكم ماء، ما فيه شي ينشرى.", category: "rest", priceBand: 1, startTime: "12:30" },
    ],
  },
  {
    key: "maldives-island",
    ...
    places: [
      { name: "Maafushi", nameAr: "مافوشي", why: "A local island of about three thousand people, half an hour by speedboat: a harbour, a school, a mosque and guesthouses. This is the Maldives that is a country, not a lagoon.", whyAr: "جزيرة أهلية فيها قرابة ثلاثة آلاف نسمة، نص ساعة بالقارب السريع: ميناء ومدرسة ومسجد وبيوت ضيافة. هذي المالديف كبلد، مو كبحيرة.", category: "walk", priceBand: 1, startTime: "09:30" },
      { name: "Hiyala Mariyaad", nameAr: "هيالا مارياد", why: "Maldivian home food on Maafushi's one street: garudhiya, a clear tuna broth you pour over rice with lime and chilli, and mas huni with flatbread if anything is left from the morning.", whyAr: "أكل مالديفي بيتي بشارع مافوشي الوحيد: «غارودِيا» مرق تونة صافي تصبونه على الرز مع ليمون وفلفل، و«ماس هوني» مع خبز رقاق إذا بقي شي من الصبح.", category: "food", priceBand: 1, startTime: "12:00", dietary: ["halal", "seafood"] },
      { name: "Gulhi", nameAr: "غولهي", why: "Twenty minutes further north and a tenth the size — a fishing island with one street, and a sandbank off its western tip that surfaces at low tide.", whyAr: "عشرين دقيقة شمالًا وبعُشر الحجم — جزيرة صيد بشارع واحد، وفيها لسان رملي بطرفها الغربي يطلع وقت الجزر.", category: "nature", priceBand: 1, startTime: "13:30" },
    ],
  },
];
...
const NUSA_PENIDA_DAYTRIP: CuratedDay = {
  ...
  places: [
    { name: "Kelingking Beach", nameAr: "شاطئ كيلينغكينغ", why: "The boat from Sanur leaves at 7:30 so your pickup is at six — and this headland is why people still do it. The viewpoint is five minutes from the car park; the climb down is an hour of rope and ladder each way.", whyAr: "القارب من سانور يطلع ٧:٣٠ فالتوصيلة الساعة ستة — وهالرأس الصخري هو السبب اللي يخلي الناس تسويها. المطل على بعد خمس دقايق من الموقف؛ والنزول ساعة حبال وسلالم بكل اتجاه.", category: "nature", priceBand: 1, startTime: "09:30" },
    { name: "Broken Beach", nameAr: "الشاطئ المكسور", why: "A circular cove with an arch the sea cut through the cliff — walk the rim clockwise and look down into the pool for manta rays, they pass through in the morning.", whyAr: "خليج دائري وقوس قطعه البحر بالجرف — لفوا الحافة مع عقارب الساعة وطالعوا البركة تحت، شفنين المانتا يعبرون منها الصبح.", category: "nature", priceBand: 1, startTime: "11:30" },
    { name: "Angel's Billabong", nameAr: "أنجلز بيلابونغ", why: "A natural rock pool beside Broken Beach that is only safe at dead low tide — if there is any swell at all, look at it and do not get in. People have drowned here.", whyAr: "بركة صخرية طبيعية جنب الشاطئ المكسور وما تأمن إلا بأقصى الجزر — وإذا فيه أي موج، تفرجوا وبس ولا تنزلون. ناس غرقوا هنا.", category: "nature", priceBand: 1, startTime: "12:15" },
    { name: "Crystal Bay", nameAr: "خليج كريستال", why: "The one beach on the island you can actually swim off — leave it until late, it faces west, and the boats back to Sanur go at four.", whyAr: "الشاطئ الوحيد بالجزيرة اللي تقدرون تسبحون منه فعلًا — خلوه للآخر، يواجه الغرب، وقوارب الرجعة لسانور الساعة أربعة.", category: "nature", priceBand: 1, startTime: "15:00" },
  ],
};
