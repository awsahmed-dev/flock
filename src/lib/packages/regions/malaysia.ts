...
const KUALA_LUMPUR_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      { name: "KL Forest Eco Park", nameAr: "منتزه غابة كوالالمبور", why: "Nine hectares of original rainforest the city built around instead of over — the canopy walkway is free and opens at seven.", whyAr: "تسعة هكتارات غابة أصلية بنت المدينة حولها بدل ما تبني فوقها — وممشى القمم مجاني ويفتح الساعة سبعة.", category: "nature", priceBand: 0, startTime: "09:00" },
      { name: "Menara Kuala Lumpur", nameAr: "برج كوالالمبور", why: "A lower tower on a higher hill, so the deck beats the Twin Towers — and it is the one place you can photograph the towers themselves.", whyAr: "برج أقصر لكنه على تلة أعلى، فإطلالته تغلب برجي بتروناس — وهو المكان الوحيد اللي تصورون منه البرجين نفسهم.", category: "sight", priceBand: 2, startTime: "10:30" },
      { name: "Thean Hou Temple", nameAr: "معبد ثين هاو", why: "Six tiers of red lanterns on a hill nobody thinks to climb — go for the terrace, which frames the entire southern skyline.", whyAr: "ست طبقات فوانيس حمراء على تلة ما أحد يفكر يطلعها — اطلعوا للشرفة، تأطّر أفق الجنوب كامل.", category: "sight", priceBand: 0, startTime: "15:00" },
      { name: "Saloma Link Bridge", nameAr: "جسر سالومة", why: "A footbridge shaped like folded sireh leaves that lights up at seven — this is the shot of the Twin Towers everyone assumes was taken from a drone.", whyAr: "جسر مشاة على شكل ورق السيريه المطوي يضوي الساعة سبعة — ومنه الصورة اللي يظن الكل إنها مصورة بدرون.", category: "walk", priceBand: 0, startTime: "19:30" },
    ],
  },
];
...
const LANGKAWI_DAYS: CuratedDay[] = [
  ...
  },
  {
    ...
    places: [
      { name: "Oriental Village", nameAr: "القرية الشرقية", why: "Be here at opening: the cable car is a twenty-minute queue at nine and a two-hour one by noon, and the summit clouds over after eleven.", whyAr: "كونوا هنا مع الافتتاح: التلفريك طابور عشرين دقيقة الساعة تسعة وساعتين الظهر، والقمة تتغطى بالغيم بعد الحادية عشرة.", category: "shop", priceBand: 1, startTime: "08:30" },
      { name: "Langkawi Sky Bridge", nameAr: "الجسر المعلق بلنكاوي", why: "A curved deck hung from one mast at 700 metres — on a clear morning the Thai islands are sitting on the horizon to the north.", whyAr: "ممشى منحني معلق من صارية وحدة على ارتفاع ٧٠٠ متر — وبصباح صافي تشوفون الجزر التايلاندية على الأفق شمالًا.", category: "sight", priceBand: 2, startTime: "09:30" },
      { name: "Telaga Tujuh Waterfall", nameAr: "شلال تيلاغا توجوه", why: "Seven pools stepping down the same hillside the cable car climbs — the lowest is a ten-minute walk, the top is a hard twenty and worth it.", whyAr: "سبع برك تنزل درج على نفس المنحدر اللي يطلعه التلفريك — أدناها عشر دقايق مشي، وأعلاها عشرين دقيقة تعب وتستاهل.", category: "nature", priceBand: 0, startTime: "12:00" },
    ],
  },
  {
    key: "langkawi-kilim",
  ...
  },
  {
    ...
    places: [
      { name: "Pulau Dayang Bunting", nameAr: "جزيرة دايانغ بونتينغ", why: "A freshwater lake sitting inside a sea island, twenty metres from salt water — you swim in it, and it is warm all the way down.", whyAr: "بحيرة ماء عذب داخل جزيرة بالبحر، وعلى بعد عشرين متر من الماء المالح — تسبحون فيها، ودافية لين القاع.", category: "nature", priceBand: 2, startTime: "09:00" },
      { name: "Pulau Singa Besar", nameAr: "جزيرة سينغا بيسار", why: "The boats cut the engines in the channel and the sea eagles come down one after another — bring the zoom, and ask your captain not to feed them.", whyAr: "القوارب تطفي محركاتها بالممر وتنزل نسور البحر وحدة ورا الثانية — خذوا عدسة تقريب، واطلبوا من القبطان ما يطعمها.", category: "nature", priceBand: 1, startTime: "11:30" },
      { name: "Pulau Beras Basah", nameAr: "جزيرة بيراس باسه", why: "White sand, shallow water, and ninety minutes is exactly the right amount of it — the last boats back leave at four.", whyAr: "رمل أبيض وماء ضحل، وساعة ونص هي المدة المضبوطة له — وآخر قوارب الرجعة الساعة أربعة.", category: "nature", priceBand: 0, startTime: "13:00" },
      { name: "Yasmin Syrian Restaurant", nameAr: "مطعم ياسمين السوري", why: "Ten minutes back from the jetty: charcoal shish taouk and kebab, hummus and bread straight out of the oven, and the menu is in Arabic.", whyAr: "عشر دقايق من الرصيف: شيش طاووق وكباب على الفحم، وحمص وخبز طالع من الفرن، والمنيو بالعربي.", category: "food", priceBand: 2, startTime: "19:00", dietary: ["halal"] },
    ],
  },
];
...
const BATU_CAVES_DAYTRIP: CuratedDay = {
  ...
  places: [
    { name: "Batu Caves", nameAr: "كهوف باتو", why: "Two hundred and seventy-two painted steps under a gold statue forty-three metres high — be on them by half seven, before the heat and the macaques wake up.", whyAr: "مئتين واثنين وسبعين درجة ملوّنة تحت تمثال ذهبي بارتفاع ٤٣ متر — كونوا عليها الساعة ٧:٣٠، قبل ما يصحى الحر والقرود.", category: "sight", priceBand: 0, startTime: "07:30" },
    { name: "Ramayana Cave", nameAr: "كهف رامايانا", why: "The quiet cave at the far left of the complex — the whole Ramayana painted in dioramas, and almost every bus walks straight past it.", whyAr: "الكهف الهادي بأقصى يسار الموقع — ملحمة رامايانا كاملة بمجسمات ملوّنة، وتقريبًا كل الباصات تعديه.", category: "sight", priceBand: 1, startTime: "09:30" },
    { name: "Zoo Negara", nameAr: "حديقة الحيوان الوطنية", why: "Twenty-five minutes on from the caves — go after three, when the heat breaks and the tapirs and sun bears finally come out of the shade.", whyAr: "خمسة وعشرين دقيقة بعد الكهوف — ادخلوا بعد الثالثة، لما يخف الحر ويطلع التابير والدببة الشمسية من الظل.", category: "nature", priceBand: 2, startTime: "15:00" },
  ],
};
...
const PUTRAJAYA_DAYTRIP: CuratedDay = {
  ...
  places: [
    { name: "Putra Mosque", nameAr: "مسجد بوترا", why: "Rose granite that goes pink at the water line, standing half over the lake — robes at the door, and the basement hall stays cool when the square outside is 35 degrees.", whyAr: "جرانيت وردي يزداد وردة عند خط الماء، ونصف المسجد فوق البحيرة — رداء عند الباب، والقاعة السفلية باردة والساحة برا ٣٥ درجة.", category: "sight", priceBand: 0, startTime: "09:30" },
    { name: "Perdana Putra", nameAr: "بردانا بوترا", why: "The green-domed building on every Putrajaya postcard is the prime minister's office — you can't go in, but the square in front of it is the best angle on the mosque.", whyAr: "المبنى ذو القبة الخضراء اللي بكل بطاقات بوتراجايا هو مكتب رئيس الوزراء — ما تدخلونه، لكن الساحة قدامه أحسن زاوية على المسجد.", category: "sight", priceBand: 0, startTime: "10:45" },
    { name: "Seri Wawasan Bridge", nameAr: "جسر سري واواسان", why: "A sail-shaped cable bridge you are allowed to walk — the footway is on the lake side and the crossing takes ten minutes.", whyAr: "جسر معلق على شكل شراع ومسموح تمشونه — ممر المشاة على جهة البحيرة والعبور عشر دقايق.", category: "walk", priceBand: 0, startTime: "12:00" },
    { name: "Masjid Tuanku Mizan Zainal Abidin", nameAr: "مسجد توانكو ميزان زين العابدين", why: "The Iron Mosque: seventy per cent steel, walls of laser-cut mesh instead of stone, so the prayer hall is lit entirely by pattern. Emptier and stranger than the pink one.", whyAr: "المسجد الحديدي: سبعين بالمئة فولاذ، وجدرانه شبك مقصوص بالليزر بدل الحجر، فالقاعة كلها مضاءة بالزخرفة. أهدى وأغرب من الوردي.", category: "sight", priceBand: 0, startTime: "16:00" },
  ],
};
