...
const PHUKET_DAYS: CuratedDay[] = [
  {
    ...
    places: [
      { name: "Kata Beach", nameAr: "شاطئ كاتا", why: "An hour south of the airport, and the last twenty minutes of that road is the point — a wide bay, calm water from November to April, and nothing like Patong.", whyAr: "ساعة جنوب المطار، وآخر عشرين دقيقة من الطريق هي المقصد — خليج واسع وماء هادي من نوفمبر لأبريل، ولا يشبه باتونغ أبدًا.", category: "nature", priceBand: 0, startTime: "16:00" },
      { name: "Karon Viewpoint", nameAr: "مطل كارون", why: "Fifteen minutes uphill from Kata: three bays in one frame, and the sun goes down at the right-hand end of it. Come at six, leave at seven.", whyAr: "ربع ساعة طلوع من كاتا: ثلاثة خلجان بإطار واحد، والشمس تغيب بطرفه الأيمن. تعالوا الساعة ستة وارجعوا سبعة.", category: "sight", priceBand: 0, startTime: "18:00" },
      { name: "Kata Walking Street Night Market", nameAr: "سوق كاتا الليلي", why: "One street behind the beach, closed to cars after dark — whole squid grilled flat, chicken satay over coals, pad thai off a wok and mango sticky rice. Order by pointing; almost nothing is over a hundred baht.", whyAr: "شارع واحد خلف الشاطئ، يُقفل بوجه السيارات بعد الظلام — حبار كامل مشوي مفرود، وسيخ دجاج ساتاي على الجمر، وباد تاي من المقلاة، ورز حلو بالمانجو. اطلبوا بالإشارة؛ وبالكاد شي يتعدى مئة بات.", category: "food", priceBand: 1, startTime: "19:30", dietary: ["seafood", "unverified"] },
    ],
  },
  {
    key: "phuket-oldtown",
...
const PHI_PHI_DAYTRIP: CuratedDay = {
  ...
  titleAr: "بي بي بيوم",
  places: [
    { name: "Maya Bay", nameAr: "خليج مايا", why: "Closed for four years to let the reef recover and reopened with rules: no boats in the bay, no swimming off the sand, one hour. Take the first ferry and you get it nearly empty.", whyAr: "سكّروه أربع سنوات لين تعافت الشعاب وفتحوه بشروط: ما فيه قوارب داخل الخليج ولا سباحة من الرمل، وساعة وحدة بس. خذوا أول عبّارة وبتلقونه شبه فاضي.", category: "nature", priceBand: 2, startTime: "09:30" },
    { name: "Pileh Lagoon", nameAr: "بحيرة بيليه", why: "A shallow lagoon walled in by limestone cliffs, with water the colour of a swimming pool — get in from the boat, the walls go straight down.", whyAr: "بحيرة ضحلة تحيط بها جروف جيرية، ولون مائها مثل المسابح — انزلوا من القارب، الجدران نازلة عمودي.", category: "nature", priceBand: 2, startTime: "11:00" },
    { name: "Phi Phi Don", nameAr: "جزيرة في في دون", why: "The only inhabited island of the group — climb to the viewpoint above Tonsai for the two bays meeting at the sandbar, then take the boat back before the afternoon wind.", whyAr: "الجزيرة المسكونة الوحيدة بالمجموعة — اطلعوا للمطل فوق تونساي وشوفوا الخليجين يلتقيان عند الحاجز الرملي، وارجعوا بالقارب قبل ريح العصر.", category: "walk", priceBand: 1, startTime: "13:00" },
  ],
};
